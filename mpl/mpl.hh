...
template<bool B, bool... Bs> constexpr bool AllOf = AllOf<B && AllOf<Bs...>>;
template<> constexpr bool AllOf<true> = true;
template<> constexpr bool AllOf<false> = false;
...
template<typename T> constexpr bool IsBothCv{IsConst<T> && IsVolatile<T>};
template<typename T> constexpr bool IsEitherCv{IsConst<T> || IsVolatile<T>};
template<typename T> constexpr bool IsNullPointer{IsSame<RemoveCv<T>, std::nullptr_t>};
