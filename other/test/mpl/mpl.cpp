...
int main() {
    ...
    //UTILITIES
    static_assert(!AllOf<false, false>, "");
    static_assert(!AllOf<false, true>, "");
    static_assert(!AllOf<true, false>, "");
    static_assert(AllOf<true, true>, "");

    static_assert(!AnyOf<false, false>, "");
    static_assert(AnyOf<false, true>, "");
    static_assert(AnyOf<true, false>, "");
    static_assert(AnyOf<true, true>, "");

    static_assert(NoneOf<false, false>, "");
    static_assert(!NoneOf<false, true>, "");
    static_assert(!NoneOf<true, false>, "");
    static_assert(!NoneOf<true, true>, "");
...
//    static_assert(IsMemberFunctionPointer<void(AbsVD::*)()>, ""); //Clang bug
...
//    static_assert(IsTriviallyAssignable<AssignInt, int>, "");
...
//    static_assert(IsTriviallyMoveConstructible<AssignInt>, "");
    ...
    static_assert(IsNullPointer<decltype(nullptr)>, "");
